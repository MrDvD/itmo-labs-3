...
if __name__ == "__main__":
    ...
    ReportFiller.plot_sequence_histogram(sequence, sequence_hist_plot_path, tau=context['hist_nodes'])
    ReportFiller.plot_sequence_with_erlang_density(context, sequence, erlang_plot_path, tau=context['hist_nodes'])

    ReportFiller.plot_sequence(erlang_sequence, generated_sequence_plot_path)
    ReportFiller.plot_sequence_histogram(erlang_sequence, generated_sequence_hist_plot_path, tau=context['hist_nodes'])
